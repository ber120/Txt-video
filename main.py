...
my_name = "🅱︎🅴︎🆁︎🅻︎🅸︎🅽︎🦅🦅"
CHANNEL_ID = "-1002730699684"##change it with your channel 🆔 
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            try:  
                ...
                cc = f'**🎞️ VID_ID: {str(count).zfill(3)}.\n\n📝 Title: {name1} {my_name} {res}.🅱︎🅴︎🆁︎🅻︎🅸︎🅽︎.mkv\n\n📚 Batch Name: {b_name}\n\n📥 Extracted By : {CR}\n\n**━━━━━✦{my_name}✦━━━━━**'
                cc1 = f'**📁 PDF_ID: {str(count).zfill(3)}.\n\n📝 Title: {name1} {my_name}.🅱︎🅴︎🆁︎🅻︎🅸︎🅽︎.pdf\n\n📚 Batch Name: {b_name}\n\n📥 Extracted By : {CR}\n\n**━━━━━✦{my_name}✦━━━━━**'
                cyt = f'**🎞️ VID_ID: {str(count).zfill(3)}.\n\n📝 Title: {name1} {my_name}.🅱︎🅴︎🆁︎🅻︎🅸︎🅽︎.mkv\n\n📚 Batch Name: {b_name}\n\n**🔗 𝐕𝐢𝐝𝐞𝐨 𝐥𝐢𝐧𝐤 - ({url})**\n\n📥 Extracted By : {CR}\n\n**━━━━━✦{my_name}✦━━━━━**'
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            try:  
                ...
                cc = f'**🎞️ VID_ID: {str(count).zfill(3)}.\n\n Title: {name1} @🅱︎🅴︎🆁︎🅻︎🅸︎🅽︎ {res}.mkv\n\n📚 Batch Name: {b_name}\n\n📥 Extracted By : {CR}\n\n**━━━━━🅱︎🅴︎🆁︎🅻︎🅸︎🅽︎✦━━━━━**'
                cc1 = f'**📁 PDF_ID: {str(count).zfill(3)}.\n\n Title: {name1} @🅱︎🅴︎🆁︎🅻︎🅸︎🅽︎.pdf\n\n📚 Batch Name: {b_name}\n\n📥 Extracted By : {CR}\n\n**━━━━━✦🅱︎🅴︎🆁︎🅻︎🅸︎🅽︎✦━━━━━**'
